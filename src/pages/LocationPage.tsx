        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="bg-gradient-to-br from-gray-900 to-gray-950 border-2 border-gold/30 rounded-2xl p-8">
              ...
              <button className="mt-8 flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-gold to-yellow-500 text-black font-semibold rounded-lg hover:from-yellow-500 hover:to-gold transition-all duration-300">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-950 border-2 border-gold/30 rounded-2xl p-8">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-white font-semibold mb-2">By Public Transport</h4>
                ...
                <div>
                  <h4 className="text-white font-semibold mb-2">By Car</h4>
                  <p className="text-gray-400">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-2">By Taxi/Uber</h4>
                  <p className="text-gray-400">
          ...
          <div className="bg-gradient-to-br from-gray-900 to-gray-950 border-2 border-gold/30 rounded-2xl p-8">
            ...
            <div className="w-full h-96 bg-gray-900 rounded-lg flex items-center justify-center border border-gold/20">
              <div className="text-center">
                ...
                <p className="text-gray-500 text-sm mt-2">Hauptstraße 123, 12345 Berlin</p>
              </div>
            </div>
