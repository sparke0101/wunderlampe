          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm sm:text-base text-light-gray font-body">
              <div className="flex justify-between">
                ...
                <span className="text-white">{t('mondayFridayTime')}</span>
              </div>
              <div className="flex justify-between">
                <span>{t('weekendHours')}</span>
                <span className="text-white">{t('weekendTime')}</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm sm:text-base text-light-gray font-body">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info.wunderlampe@gmail.com" className="hover:text-gold transition-colors break-all">info.wunderlampe@gmail.com</a>
              </div>
            </div>
          </div>
        ...
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-gold/20">
          ...
          <div className="mb-6 sm:mb-8 text-center">
            <div className="bg-gradient-to-br from-gray-900 to-gray-950 border-2 border-gold/30 rounded-2xl p-4 sm:p-6 md:p-8 max-w-md mx-auto">
              <h3 className="text-xl sm:text-2xl font-display font-bold text-gold mb-3 sm:mb-4">{t('joinCommunity')}</h3>
              <p className="text-sm sm:text-base text-light-gray font-body mb-4 sm:mb-6">
                {t('communityDescription')}
              </p>
              
              <p className="text-sm sm:text-base text-light-gray font-body mb-4 sm:mb-6">
                {t('communityDescriptionLong')}
              </p>
              ...
              >
                ...
                <span className="text-center">{t('joinWhatsApp')}</span>
              </a>
            </div>
          </div>
