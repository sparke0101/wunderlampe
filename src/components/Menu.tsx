...
export default function Menu() {
  ...
  const menuItems = {
    ...
    shisha: [
      { name: 'Royal Mint', price: '25€', description: 'Premium Mint Blend' },
      { name: 'Golden Apple', price: '28€', description: 'Sweet Apple with Gold Tobacco' },
      { name: 'Mystic Berry', price: '26€', description: 'Mixed Berry Premium' },
      { name: 'Desert Rose', price: '30€', description: 'Rose & Honey Luxury Blend' },
      { name: 'Neon Punch', price: '27€', description: 'Tropical Fruit Mix' },
      { name: 'Velvet Smoke', price: '32€', description: 'Vanilla & Caramel Supreme' },
      { name: 'Royal Grape', price: '29€', description: 'Premium Grape Blend' },
      { name: 'Golden Peach', price: '26€', description: 'Sweet Peach & Cream' },
